...
## This code builds the industrial sector dataset used to produce results in the
## manuscript. #################################################################
################################################################################
...
data <- read_excel(destfile, sheet = 4, skip = 1)
head(data)
...
#### SAVE
save(final_data,n_until2015,file=paste0(project.dir,"/final_data_industrial.RData"))
