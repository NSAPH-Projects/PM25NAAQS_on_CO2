...
## This code reproduces results in Table S9 (line "Temperature") in the ########
...
for(s in unique(final_data$State)){
  ...
  ce <- CausalArima(y = ts(log(data$Temperature), start = 1, frequency = 1), 
                    dates = dates, 
  ...
  avg_distr_0509 <- colMeans(data$Temperature[data$Year>=2005&data$Year<=2009] - 
  ...
  avg_distr_0512 <- colMeans(data$Temperature[data$Year>=2005&data$Year<=2012] - 
  ...
  avg_distr_0514 <- colMeans(data$Temperature[data$Year>=2005&data$Year<=2014] - 
...
saveRDS(res_2009, file = paste0(project.dir,"/supplementary_results/temperature_20052009.rds"))
saveRDS(res_2012, file = paste0(project.dir,"/supplementary_results/temperature_20052012.rds"))
saveRDS(res_2014, file = paste0(project.dir,"/supplementary_results/temperature_20052014.rds"))
saveRDS(res_2009_rel, file = paste0(project.dir,"/supplementary_results/temperature_rel_20052009.rds"))
saveRDS(res_2012_rel, file = paste0(project.dir,"/supplementary_results/temperature_rel_20052012.rds"))
saveRDS(res_2014_rel, file = paste0(project.dir,"/supplementary_results/temperature_rel_20052014.rds"))
saveRDS(tableS9, file = paste0(project.dir,"/tables/TableS9_Temperature.rds"))
