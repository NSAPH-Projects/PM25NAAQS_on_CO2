...
## This code reproduces results Figure S3, Table S2 (line "Industrial") and ####
...
# upload data
load(paste0(project.dir,"/final_data_industrial.RData"))
...
saveRDS(s_res2009, file = paste0(project.dir,"/main_results/meta_analysis_20052009_industrial.rds"))
saveRDS(s_res2012, file = paste0(project.dir,"/main_results/meta_analysis_20052012_industrial.rds"))
saveRDS(s_res2014, file = paste0(project.dir,"/main_results/meta_analysis_20052014_industrial.rds"))
saveRDS(s_res2009_rel, file = paste0(project.dir,"/main_results/meta_analysis_rel_20052009_industrial.rds"))
saveRDS(s_res2012_rel, file = paste0(project.dir,"/main_results/meta_analysis_rel_20052012_industrial.rds"))
saveRDS(s_res2014_rel, file = paste0(project.dir,"/main_results/meta_analysis_rel_20052014_industrial.rds"))
saveRDS(table1, file = paste0(project.dir,"/main_results/TableS2_industrial.rds"))
...
print(doc, target = paste0(project.dir,"/tables/TableS4.docx"))
...
jpeg(file = paste0(project.dir,"/plots/FigS3.jpeg"),
