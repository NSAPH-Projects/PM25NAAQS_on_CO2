...
## This code reproduces results Figure S4, Table S2 (line "Transportation") and 
...
# upload data
load(paste0(project.dir,"/final_data_transportation.RData"))
...
saveRDS(s_res2009, file = paste0(project.dir,"/main_results/meta_analysis_20052009_transportation.rds"))
saveRDS(s_res2012, file = paste0(project.dir,"/main_results/meta_analysis_20052012_transportation.rds"))
saveRDS(s_res2014, file = paste0(project.dir,"/main_results/meta_analysis_20052014_transportation.rds"))
saveRDS(s_res2009_rel, file = paste0(project.dir,"/main_results/meta_analysis_rel_20052009_transportation.rds"))
saveRDS(s_res2012_rel, file = paste0(project.dir,"/main_results/meta_analysis_rel_20052012_transportation.rds"))
saveRDS(s_res2014_rel, file = paste0(project.dir,"/main_results/meta_analysis_rel_20052014_transportation.rds"))
saveRDS(table1, file = paste0(project.dir,"/main_results/TableS2_transportation.rds"))
...
print(doc, target = paste0(project.dir,"/tables/TableS5.docx"))
...
jpeg(file = paste0(project.dir,"/plots/FigS4.jpeg"),
