...
## This code reproduces results in Table S9 (line "GDP") in the Supplementary ##
## Materials. ##################################################################
################################################################################
...
ce <- CausalArima(y = ts(data$gdp, start = 1, frequency = 1), 
                  dates = dates, 
...
avg_distr_0509 <- colMeans(data$gdp[data$Year>=2005&data$Year<=2009] - 
...
avg_distr_0512 <- colMeans(data$gdp[data$Year>=2005&data$Year<=2012] - 
...
avg_distr_0514 <- colMeans(data$gdp[data$Year>=2005&data$Year<=2014] - 
...
saveRDS(tableS9, file = paste0(project.dir,"/tables/TableS9_GDP.rds"))
