...
## This code reproduces results Figure S5, Table S2 (line "Commercial") and ####
...
# upload data
load(paste0(project.dir,"/final_data_commercial.RData"))
...
saveRDS(table1, file = paste0(project.dir,"/main_results/TableS2_commercial.rds"))
...
print(doc, target = paste0(project.dir,"/tables/TableS6.docx"))
...
jpeg(file = paste0(project.dir,"/plots/FigS5.jpeg"),
