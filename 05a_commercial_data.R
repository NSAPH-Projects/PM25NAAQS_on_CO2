...
## This code builds the commercial sector dataset used to produce results in the
## manuscript. #################################################################
################################################################################
...
#### SAVE
save(final_data,n_until2015,file=paste0(project.dir,"/final_data_commercial.RData"))
