...
## This code reproduces results Figure S6, Table S2 (line "Residential") and ###
## Table S7 in the Supplementary Materials. ####################################
################################################################################
...
# upload data
load(paste0(project.dir,"/final_data_residential.RData"))
...
saveRDS(s_res2009, file = paste0(project.dir,"/main_results/meta_analysis_20052009_residential.rds"))
saveRDS(s_res2012, file = paste0(project.dir,"/main_results/meta_analysis_20052012_residential.rds"))
saveRDS(s_res2014, file = paste0(project.dir,"/main_results/meta_analysis_20052014_residential.rds"))
...
print(doc, target = paste0(project.dir,"/tables/TableS7.docx"))
