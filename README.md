...
- 01b_main_analysis.R: this script reproduces Fig. 3, results of the meta-analysis reported in text in the manuscript (section "Counterfactual analysis"), Table S1 and Table S2 (line "Total") in the Supplementary Materials.
