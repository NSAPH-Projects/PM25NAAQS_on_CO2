...
## This code builds the main dataset used to produce results in the manuscript.#
################################################################################
...
# Download the CO2 total emissions dataset
...
#### SAVE
save(final_data,n_until2015,file=paste0(project.dir,"/final_data.RData"))
